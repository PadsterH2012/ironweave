<script lang="ts">
  ...
  const featureCoverage: CoverageItem[] = [
    ...
    { feature: 'Dashboard', tested: ['Stat cards', 'KillSwitch widget', 'System health panel', 'Metrics chart', 'Agent util chart', 'Merge health chart', 'Activity feed', 'Loom feed'], missing: [] },
    { feature: 'Projects', tested: ['List renders', 'Create project', 'Navigate to detail', 'Delete via API', 'Edit project via API', 'Update structure validation'], missing: [] },
    { feature: 'Teams', tested: ['List renders', 'Create team', 'Mode selection', 'Delete via API', 'Activate/deactivate API', 'Templates API', 'Team status API', 'Slot CRUD via API'], missing: [] },
    { feature: 'Issues', tested: ['Board columns', 'Create issue', 'Create with type/priority', 'Detail modal', 'Status change via API', 'Delete via API', 'Ready issues API', 'Children API', 'Status change via UI', 'Attachment upload API'], missing: [] },
    { feature: 'Workflows', tested: ['Tab renders', 'Create definition via API', 'Create instance via API', 'Pause/resume/cancel API', 'Definition structure', 'Instance structure', 'DAG container renders'], missing: [] },
    { feature: 'Merge Queue', tested: ['Tab renders', 'Queue API list', 'Entry structure validation', 'Entry display', 'Full entry field validation', 'Diff endpoint contract', 'Approve/reject/resolve API contracts'], missing: [] },
    { feature: 'Loom', tested: ['Feed renders', 'Entry structure', 'Loom API list', 'Create entry API'], missing: [] },
    { feature: 'Mounts', tested: ['List renders', 'Create form fields', 'Cancel form', 'Status API', 'Mount structure validation', 'Mount/unmount API contracts'], missing: [] },
    { feature: 'Settings', tested: ['General form fields', 'Proxies tab', 'API Keys tab', 'Save settings', 'Settings API CRUD', 'Proxy configs API'], missing: [] },
    { feature: 'Killswitch', tested: ['Dashboard toggle', 'Per-project pause/resume', 'Schedule visibility', 'Schedule CRUD via API', 'Dispatch status API', 'Project dispatch status API', 'Per-project detail toggle', 'Cron validation (valid + invalid)'], missing: [] },
    { feature: 'Quality & Routing', tested: ['Quality tab renders', 'Routing tab renders', 'Detect patterns', 'Create override via API', 'Quality tiers API', 'Project quality get/set API', 'Override reject API'], missing: [] },
    { feature: 'Costs', tested: ['Cost dashboard renders', 'Cost summary API', 'Daily spend API', 'Aggregate trigger API', 'Time range selector'], missing: [] },
    { feature: 'Coordinator', tested: ['Panel renders', 'Wake/sleep toggle'], missing: [] },
    { feature: 'Prompts', tested: ['Editor renders', 'Create template', 'Delete via API', 'Role assignment API', 'Build prompt preview API'], missing: [] },
    { feature: 'Test Runner', tested: ['Tab renders', 'Trigger run', 'Run detail panel', 'Quick-trigger button', 'History list'], missing: [] },
    { feature: 'Agents', tested: ['Page renders', 'Empty state', 'Agents API list', 'Dead agents cleanup API', 'Runtimes API', 'Spawn API contract', 'WebSocket endpoint'], missing: [] },
    ...
    { feature: 'Features', tested: ['Tab renders', 'Feature list', 'Status filters', 'Add Feature', 'Import PRD', 'Create via API', 'Task CRUD', 'Implement→issue', 'Park/verify', 'Summary API'], missing: [] },
    { feature: 'Details', tested: ['Tab renders', 'Intent editor', 'Reality panel', 'Save + versioning', 'Rescan', 'Document API CRUD', 'Gap analysis', 'History API'], missing: [] },
