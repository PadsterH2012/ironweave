<script lang="ts">
  ...
  const featureCoverage: CoverageItem[] = [
    ...
    { feature: 'Teams', tested: ['List renders', 'Create team', 'Mode selection', 'Delete via API', 'Activate/deactivate API', 'Templates API', 'Team status API'], missing: ['Agent slot CRUD'] },
    ...
    { feature: 'Merge Queue', tested: ['Tab renders', 'Queue API list', 'Entry structure validation', 'Entry display'], missing: ['Approve/reject merge', 'Diff viewer', 'Conflict resolution'] },
    ...
    { feature: 'Killswitch', tested: ['Dashboard toggle', 'Per-project pause/resume', 'Schedule visibility', 'Schedule CRUD via API', 'Dispatch status API', 'Project dispatch status API', 'Per-project detail toggle'], missing: ['Cron expression validation'] },
