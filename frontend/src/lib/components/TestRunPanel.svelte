<script lang="ts">
  ...
  const featureCoverage: CoverageItem[] = [
    ...
    { feature: 'Issues', tested: ['Board columns', 'Create issue', 'Create with type/priority', 'Detail modal', 'Status change via API', 'Delete via API', 'Ready issues API', 'Children API'], missing: ['Drag between columns', 'Attachments upload'] },
    { feature: 'Workflows', tested: ['Tab renders', 'Create definition via API', 'Create instance via API', 'Pause/resume/cancel API', 'Definition structure', 'Instance structure'], missing: ['DAG visualization'] },
    { feature: 'Merge Queue', tested: ['Tab renders', 'Queue API list', 'Entry structure validation', 'Entry display', 'Full entry field validation', 'Diff endpoint contract'], missing: ['Approve/reject (needs real branches)'] },
    { feature: 'Loom', tested: ['Feed renders', 'Entry structure', 'Loom API list', 'Create entry API'], missing: [] },
    { feature: 'Mounts', tested: ['List renders', 'Create form fields', 'Cancel form', 'Status API', 'Mount structure validation'], missing: ['Mount/unmount action'] },
    ...
    { feature: 'Agents', tested: ['Page renders', 'Empty state', 'Agents API list', 'Dead agents cleanup API', 'Runtimes API'], missing: ['Spawn agent', 'WebSocket terminal'] },
